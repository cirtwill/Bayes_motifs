...
def main():
	...
	role_dict,full_positions=read_role_file('../data/roles/acyclic/')
	good_positions=sort_nonzero_roles(role_dict,full_positions)
	print 'roles read'
	# partic_dict takes s, c, network, species, size, motif: count
	# full_motifs is a dict for size: motif
	partic_dict,full_motifs=read_participation_file('../data/motif_participation/acyclic/')
	...
	persfile='../data/all_new.tsv' # Anna's new data file
	TLdict,degdict,perdict=read_persistence_file(persfile,role_dict)
	print 'persistence read'

	linear_TLdict,linear_degdict,linear_perdict=read_persistence_file('../data/all_linear.tsv',role_dict)
	# For 3-sp file, want degree, tl, participation, role
	# For 4-sp file, want degree, tl, participation (no roles)
	collect_and_print_3sp('../data/3sp_roles_participation.tsv',role_dict,good_positions,partic_dict,good_motifs,degdict,TLdict,perdict)
	print '3sp role files complete'
	collect_and_print_4sp('../data/4sp_participation.tsv',partic_dict,good_motifs,degdict,TLdict,perdict)
	print '4sp role files complete'
			
	collect_and_print_3sp('../data/linear_3sp_roles_participation.tsv',role_dict,good_positions,partic_dict,good_motifs,linear_degdict,linear_TLdict,linear_perdict)
	print '3sp role files complete'
	collect_and_print_4sp('../data/linear_4sp_participation.tsv',partic_dict,good_motifs,linear_degdict,linear_TLdict,linear_perdict)
	print '4sp role files complete'
