...
\section*{Introduction}
    ...
    %\subsection{6. only 4 (stable) motifs can appear in Bayesian networks}
...
%Since motifs, basic building blocks of networks~\citep{Milo2002} and bridges between network-wide (global) and species-specific (local) properties, describe both direct and indirect effects, the distribution of these meso-scale structures in ecological networks is likely related to network and species persistence when the plant community is affected by species loss. 
%Since motifs describe direct and indirect effects~\citep{Milo2002}, the distribution of these meso-scale structures in ecological networks is likely related to network and species persistence after a disturbance~\citep{}.

As basic building blocks of networks~\citep{Milo2002}, motifs connect network-wide (global) and species-specific (local) properties, describing both direct and indirect effects. As such, the distribution of these meso-scale structures can be of importance to network and species persistence~\citep{}.
Indeed, we find that both the distribution of motifs at the network level and the set of motifs a target species participates in are related to persistence after disturbance to the plant community, and that the nature of these relationships synthesizes the effects of other local and global-scale properties.
...
Local properties may be especially important for the apparent competition and direct competition motifs. The indirect effects in these two motifs are not fully expressed since the Bayesian Network framework does not include top-down effects. The direct effects they do describe echo the effects of in-degree and trophic level.

However, the effects of in-degree and trophic level differed.
...
Trophic level, like motifs, includes some information about the risk of indirect effects; species at high trophic levels can be at increased risk of extinction due to disturbances at lower trophic levels~\citep{Eklof2013}. 
Species with high trophic levels also tend to have low participation in the direct competition motif, which is in turn associated with lower probability of persistence at all levels of disturbance.
...
The omnivory motif likewise integrates effects of in-degree and trophic level.
...
Following the same reasoning as above, in a highly connected network,the numerous links pave the way for a disturbance to spread to a higher extent than in a less connected network. 
