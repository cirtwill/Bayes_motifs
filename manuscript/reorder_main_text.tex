...
\section*{Introduction} %New
    ...
    The undisputable presence of large, stable, empirical networks has spurred research into how other structural characteristics, including connectance, may allow large numbers of species to persist~\citep{Dunne2002}.
    ...
    Species properties known to affect species' response to disturbances include trophic level (a measure of the path length between a consumer and a basal resource) and in-degree (number of prey items of a predator). This can be referred to local properties in the network.
...
\section*{Figures}
 ...
 %   \end{figure}
        ...
        \begin{figure}[hb!]
        \centering
        \includegraphics[width=1.0\textwidth]{manuscript/figures/concept_fig_ver2.pdf}
