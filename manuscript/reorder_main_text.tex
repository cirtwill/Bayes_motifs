...
\section*{Abstract}
    ...
    Motif participation therefore captures important trends in vulnerability to extinction and provides a rich description of species' structural roles in their communities.
...
\section*{Methods}
    ...
    \subsubsection*{5) Persistence and network properties}
        ...
        To identify the relationship between global network structure and mean probability of persistence within a network, we fit a linear regression relating mean persistence to network size, connectance, disturbance, and their interactions (Eg. S9).
