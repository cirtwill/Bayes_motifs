...
\section*{Methods}
    ...
    \subsection*{Modelling secondary extinction using Bayesian networks}
        ...
        Fortunately, they are also the motifs that are most common in empirical networks~\citep{Stouffer2007}, have been most studied in isolation (e.g.,~\citealp[]{Bascompte2005,Polis1989,Zabalo2012,Kondoh2008,Laws2013}), have the clearest ecological interpretations and, because of these three properties, are of greatest interest to us.
	...
	\subsection*{Statistical analysis} 
        ...
        \subsubsection*{2) Consumer persistence and other network structure metrics}
            ...
            When relating persistence to STL, we initially included a random effect of network size and connectance but removed these terms due to model singularity as above.
...
\section*{Discussion}
    ...
    Network structural properties such as connectance and measures of a species' position in the network such as degree and trophic level are known to affect species' vulnerability~\citep{Dunne2002, Eklof2006,bascompte2005simple,dunne2009cascading}, but are relatively coarse metrics.
    Defining a species' network role based on its participation in meso-scale motifs provides more nuanced information and may also predict extinction risk~\citep{Stouffer2012,Simmons2019,Cirtwill2018FoodWebs}, but this potential is only beginning to be explored~\citep{Cirtwill2022Oikos}.
