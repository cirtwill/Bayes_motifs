...
\section*{Results}
    ...
    \subsection*{Persistence and other network properties}
        ...
        To understand the relationships between motif participation and consumers' probabilities of persistence, it is helpful to understand how persistence varies with other aspects of network structure.
        Consumers with higher STL were less likely to persist (Fig.~\ref{fig:lm_CS}, Table S3, \emph{Appendix S6}).
...
\section*{Discussion}
    ...
    In a large set of simulated food webs, a consumer species' probability of persistence after a disturbance affecting basal resources depends on its frequency of participation in the four possible meso-scale motifs.
    ...
    Together with relationships between persistence and the overall structure of the network~\citep{Dunne2002, Eklof2006, PascualDunne2006,prill2005dynamic, bascompte2005simple} and simpler measures of species' positions within it~\citep{curtsdotter2011robustness, dunne2009cascading, Eklof2006}, these trends can help us to identify vulnerable species within a network. 


    
    % Species-level results summary
    Some of the relationships between motif participation and probability of persistence can be understood by examining relationships between motif participation and other measures of a species' place in the network.
    ...
    Relationships between motif participation and persistence can also be placed within the context of relationships between overall network structure, persistence, and the overall frequency of motifs in the network's motif profile.
    For example, since networks with higher connectance contain on average more links per species, it logically follows that they will tend to include a greater proportion of the omnivory motif in the network's motif profile (Fig. SX) and species will tend to participate in the omnivory motif (Fig. 5C). 
    As both higher connectance (Fig. 4C) and more-frequent participation in the omnivory motif (Fig. 2) are generally associated with decreased probability of persistence, it is possible that the negative effect of connectance may be because of the increased frequency of omnivory.     
    

    However, as in other studies, the effect of omnivory on persistence in our networks was highly context-dependent~\citep{bascompte2005simple, Monteiro2016,McLeod2021}.
    ...
    At high levels of disturbance, however, participating in the omnivory motif was more likely to reduce the probability of persistence.
    These trends also varied with connectance, with participation in the omnivory motif being associated with lower probability of persistence in less-connected networks and higher probability of persistence in more-connected networks as in~\citet{McLeod2021}.
    This is also consistent with earlier work showing greater food-web persistence in networks with higher counts of the omnivory motif~\citep{Stouffer2010b}.
    ...
    [[Still seems relevant but don't know where to fit this in]]
...
\section*{Figures}
        ...
        \begin{figure}[hb!]
        \centering
        \includegraphics[width=.95\textwidth]{figures/concept_fig_ver2_edit.eps}
