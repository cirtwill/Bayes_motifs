...
\section*{Methods}
    ...
    \subsubsection*{5) Persistence and network properties}
        ...
        To identify the relationships between local-scale properties and species' probabilities of persistence, we fit two final LMMs:
        \begin{equation}
                \Psi_{ink} \approx \delta_{i} + \pi_k + \delta_{i}\pi_k +
                S_{n}C_{n} ,
                \label{degeq}
            \end{equation}
        \begin{equation}
                \Psi_{ink} \approx \tau_{i} + \pi_k + \tau_{i}\pi_k +
                S_{n}C_{n} ,
                \label{TLeq}
            \end{equation}
