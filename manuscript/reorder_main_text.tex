...
\section*{Introduction} %New
    ...
    While the potential relationships between motif participation and species-level extinction risk have not yet been tested to our knowledge, it has been shown that the frequencies of different motifs within a whole network are associated with community stability \citep{prill2005dynamic, bascompte2005simple} and with changes to the composition of plant communities \citep{giling2019plant}. This indicate that motifs may provide additional information on network resilience to disturbances. 
    
    The severity of disturbances impacting structure forming species, i.e., plant species, is important for how the food web respond \citep{}. Naturally, the magnitude of the effect will increase with severity of the disturbance \citep{}, but additionally disturbances impacting structure forming species, i.e., plant species, may fundamentally alter food web structure \citep{byrnes2011climate}. This has been shown in several studies where the magnitude of the disturbances alter the competition between species in the benthic community \citep{detmer2021variation} and change the percent coverage of different taxonomic groups \citep{carnell2020more} in kelp forests. 
    ...
    This can affect the influence of motif frequencies on network stability, as it has been demonstrated that a previously unstable motif may appear stabilizing dependent on interactions with other species \citep{Kratina2012}. 

%\subsection*{Here we test...}
   Here, we are interested in whether a consumer's extinction risk of going secondary extinct depends on 1) the motifs in which the species participates, 2) the motif profile of the full food web and 3) the severity of the disturbance. %We address this in scenarios with various levels of disturbance targeting the basal level.
