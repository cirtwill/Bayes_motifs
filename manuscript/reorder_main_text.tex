...
%         After these steps, calculations of persistence probabilities can begin.
	...
	We tested:
	\noindent1) how species persistence varied with motif participation (Appendix \emph{3.1}), 
	
	\noindent2) how motif participation varied with other network properties (Appendix \emph{3.2}), 
	
	\noindent3) how network mean persistence varied with network motif profiles (Appendix \emph{3.3}), 
	
	\noindent4) how network motif profiles varied with global structural properties (Appendix \emph{3.4}), and 
	
	\noindent5) how species persistence and network mean persistence varied with other network properties (Appendix \emph{3.5}). 
