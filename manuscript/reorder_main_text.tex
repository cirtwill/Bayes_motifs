...
\section*{Introduction} %New
    ...
    Some motifs are over-represented in stable food webs, suggesting that these motifs provide stability~\citep{Borrelli2015a}. 
    This further suggests that the more frequently species participate in these motifs, the more stable the food web would be.
...
\section*{Results}
    ...
    \subsection*{Persistence and other network properties}
        ...
        These relationships are broadly similar to, but weaker than, the relationships between species' probabilities of persistence and motif participation.
