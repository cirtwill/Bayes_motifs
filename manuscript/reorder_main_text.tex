...
\section*{Methods}
    ...
    \subsection*{Network construction and describing species roles}
        ...
        We also calculated simpler measures of a species' role within its community.
    ...
    \subsection*{Modelling secondary extinction using Bayesian networks}
        ...
        A middle‐ground approach for simulating secondary extinctions is to use Bayesian networks, which are much more computationally efficient and facilitate the analysis of larger networks \citep{Eklof2013,Haussler2020}. 
        ...
        In particular, any motif which contains a cycle is impossible in an acyclic network.
        ...
        Fortunately, they are also the motifs that have been most studied in isolation (e.g.,~\citep{}) and have the clearest ecological interpretation.
	...
	% Appendix 3, with numbered subheadings.
    	...
    	We tested 1) how species persistence varied with motif participation, 2) how motif participation varied with other network properties (in-degree and trophic level, STL), 3) how network mean persistence (the average persistence of all consumers in the network) varied with network motif profiles, 4) how network motif profiles varied with large-scale structural properties (S and C), and 5) how species persistence and network mean persistence varied with other measures of network structure and species' place within it (S, C, in-degree, and trophic level).
        ...
        \subsubsection*{2) Motif participation and other network properties}    
            ...
            To identify correlations between large-scale network structure (i.e., the whole network) and participation in particular motifs (a meso-scale description of species roles), we fit a series of LMs relating motif participation to network size, connectance, and their interaction (Appendix \emph{S3.2}).
        ...
        \subsubsection*{5) Persistence and network properties}
            ...
            Persistence is known to vary with large- and small-scale network properties.
            ...
            To identify the relationship between large-scale network structure and mean probability of persistence within a network, we fit a linear regression relating mean persistence to network size, connectance, disturbance, and their interactions (Eq. S9).
            ...
            These GLMMs also included random effects to account for the effects of large-scale network structure and network ID on persistence.
