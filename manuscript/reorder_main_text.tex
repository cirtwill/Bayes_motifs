...
\section*{Figures}
    ...
    \begin{figure}[hb!]
        \centering
        \includegraphics[width=0.85\textwidth]{manuscript/figures/concept_motif.png}
        \caption{Conceptual figure of a toy food web showing how species with similar degree and trophic level can have different motif participation. }
    \label{fig:concept}
    \end{figure}
