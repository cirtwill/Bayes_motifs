...
\section{SH: Persistence and motif roles}
    ...
    \begin{figure}
        \centering
        \includegraphics{figures/persistence_positions_Apparent.eps}
    ...
    \begin{figure}
        \centering
        \includegraphics{figures/persistence_positions_Direct.eps}
    ...
    \begin{figure}
        \centering
        \includegraphics{figures/persistence_positions_Three-species.eps}
...
\section*{Proportion of basal resources in the network}
