...
\section{Network creation}
    ...
    \subsection*{Comparison of empirical and simulated networks}
        ...
        This final set of webs had 50-77 species and connectances (after rendering the networks acyclic) of 0.2-0.21 - the upper range of connectance in our simulations.
