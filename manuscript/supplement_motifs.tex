...
\section*{Table of contents}
    ...
    \begin{enumerate}
        ...
        \item Supplemental methods: Network creation \\
        ...
        \item Supplemental methods: Calculating persistence
         ...
         \item Supplemental methods: Statistical analysis
        ...
        \item Results: Persistence and motif participation
            \begin{itemize}
                \item Contains Table S1
            \end{itemize}


        \item Results: Participation and network properties
        ...
        \item Results: Persistence, degree, and trophic level
        ...
        \item Results: Motif-persistence relationships

            \begin{itemize}
                \item Contains Fig. S4
            \end{itemize}    
    
        \item Results: Persistence and network motif profiles
...
\section{Supplemental methods: Statistical analysis}
    ...
    \subsection{How does motif participation vary with network properties?}
        ...
        \noindent where $\rho_{i}$ is the frequency with which species $i$ participtes in the focal motif, $\delta_{i}$ is the in-degree of species $i$, $\tau_{i}$ is the shortest trophic level of species $i$, $S_{i}C_{i}$ is a random effect of the combination of size and connectance for the network containing species $i$.
...
\section{Results: Participation and network properties}
...
\section{Results: Motif-persistence relationships}
    ...
    The main trends are similar in both analyses, but different-sized networks showed slightly different results results for some motifs when considered individually (Figure~\ref{fig:density_prop_S}).
