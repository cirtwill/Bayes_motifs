...
\section{Statistical analysis}
    ...
    \subsection{How does mean persistence vary with motif profiles?}
        ...
        As with the PERMANOVA relating motif participation to network properties, we fit the PERMANOVA using the R~\citep{R} function `vegan' from the package \emph{adonis} and calculated significance based on 9999 permutations.
