...
\section{Statistical analysis}
    ...
    \subsection{How does persistence vary with other properties?}
        ...
        \subsubsection{Network mean persistence and network properties}
            ...
            \begin{equation}
                \Psi_{ink} \approx \Sigma_{n} + \zeta_{n} + \pi_{k} + \Sigma_{n}:\zeta_{n} + \Sigma_{n}\pi_{k} + \zeta_{n}\pi_{k} + \Sigma_{n}\zeta_{n}\pi_{k},
                \label{SCeq}
            \end{equation}
